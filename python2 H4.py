...
\033[1;91m☞ Auther     : H4_AFRIDI_A4_MASTER
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update H4_AFRIDI Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' H4_AFRIDI WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/H4_AFRIDI')
	    ...
	    psb('WellCome To H4_AFRIDI')
	    psb('Congratulations H4_AFRIDI Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel H4 AFRIDI A4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/H4_AFRIDI && python2 H4.py')
	elif bm =='3':
